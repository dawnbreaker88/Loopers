...
const steps = [
  {
    n: "01",
    title: "Browse",
    desc: "Open Loopers, pick what you need. Even one item is fine.",
    animation: searchAnim,
  },
  {
    n: "02",
    title: "Checkout",
    desc: "Add address, pay with UPI, card or cash on delivery.",
    animation: paymentAnim,
  },
  {
    n: "03",
    title: "Track",
    desc: "Watch your rider move in real time on the map.",
    animation: trackingAnim,
  },
  {
    n: "04",
    title: "Unbox",
    desc: "Delivered straight to your gate, hostel, or floor.",
    animation: packagingAnim,
  },
];

...
const avifSrcSet =
  "/assets/loopers-bag-v2-480.avif 480w, /assets/loopers-bag-v2-800.avif 800w, /assets/loopers-bag-v2-1200.avif 1200w, /assets/loopers-bag-v2-1600.avif 1600w";
const webpSrcSet =
  "/assets/loopers-bag-v2-480.webp 480w, /assets/loopers-bag-v2-800.webp 800w, /assets/loopers-bag-v2-1200.webp 1200w, /assets/loopers-bag-v2-1600.webp 1600w";
        ...
        <div className="mt-8 grid lg:grid-cols-[1.05fr_1fr] gap-10 lg:gap-6 items-center">
          ...
          >
            ...
            <p className="mt-5 max-w-md text-[0.98rem] sm:text-lg text-muted-foreground leading-relaxed">
              Loopers is a student-first quick commerce app. No minimum order, a flat{" "}
              <span className="font-semibold text-foreground">₹1 delivery fee</span>, and delivery
              from <span className="font-semibold text-foreground">7 AM – 2 AM</span>.
            </p>
            ...
            <div className="mt-8 flex items-center gap-5 text-xs text-muted-foreground">
              ...
              <div className="flex items-center gap-1.5">
                <Clock className="h-3.5 w-3.5 text-primary" strokeWidth={2.2} />7 AM – 2 AM daily
              </div>
            </div>
          </motion.div>
          ...
          <div className="order-1 lg:order-2 relative">
            <div className="relative aspect-square max-w-[28rem] sm:max-w-xl lg:max-w-2xl mx-auto">
              ...
              >
                ...
                <img
                  src="/assets/loopers-bag-v2-1200.webp"

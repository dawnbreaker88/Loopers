...
export default function BottomNav() {
  ...
  const adminNavItems = [
    { label: 'Orders', path: '/admin/orders?tab=orders', tab: 'orders', iconUrl: 'https://cdn-icons-png.flaticon.com/512/3500/3500833.png', fallbackIcon: ShoppingBag },
    { label: 'Products', path: '/admin/orders?tab=products', tab: 'products', iconUrl: 'https://cdn-icons-png.flaticon.com/512/2897/2897785.png', fallbackIcon: Package },
    { label: 'Store & Profile', path: '/admin/orders?tab=store_profile', tab: 'store_profile', iconUrl: 'https://cdn-icons-png.flaticon.com/512/869/869636.png', fallbackIcon: Store },
    { label: 'Analytics', path: '/admin/orders?tab=analytics', tab: 'analytics', iconUrl: 'https://cdn-icons-png.flaticon.com/512/3588/3588658.png', fallbackIcon: BarChart3 }
  ];

  const customerNavItems = [
    { label: 'Home', path: '/', iconUrl: 'https://cdn-icons-png.flaticon.com/512/619/619153.png', fallbackIcon: Home },
    { label: 'Search', path: '/products', iconUrl: 'https://cdn-icons-png.flaticon.com/512/954/954591.png', fallbackIcon: Search },
    { label: 'Cart', path: isAuthenticated ? '/cart' : '/login', iconUrl: 'https://img.icons8.com/fluency/96/shopping-cart.png', fallbackIcon: ShoppingCart, badge: cartItemsCount },
    { label: 'Profile', path: isAuthenticated ? '/profile' : '/login', iconUrl: 'https://cdn-icons-png.flaticon.com/512/3177/3177440.png', fallbackIcon: User }
  ];
      ...
      <nav aria-label="Admin Navigation" className="fixed bottom-0 left-0 right-0 z-30 bg-sys-surface border-t border-sys-border px-4 py-2 pb-[calc(0.5rem+env(safe-area-inset-bottom))] shadow-2xl">
        <div className="flex justify-around items-center max-w-lg mx-auto">
          {adminNavItems.map((item) => {
            const isActive = location.pathname.startsWith('/admin/orders') && activeTab === item.tab;

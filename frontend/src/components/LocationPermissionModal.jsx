    ...
    navigator.geolocation.getCurrentPosition(
      ...
      (error) => {
        ...
        if (error.code === error.PERMISSION_DENIED) {
          setErrorMsg('Location permission was denied. Please allow location access in your browser settings to proceed with campus delivery.');
        ...
        <div className="flex flex-col items-center text-center pt-2 space-y-3">
          ...
          <div>
            ...
            <p className="text-xs font-semibold text-[#64748B] dark:text-slate-400 mt-1 max-w-xs mx-auto">
              Loopers delivers right to your hostel room or campus building within 10 minutes.
            </p>
          </div>
        </div>

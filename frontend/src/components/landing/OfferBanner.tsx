  ...
  return (
    <section id="start" aria-labelledby="offer-heading" className="relative py-16 lg:py-20">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        ...
        >
          <div aria-hidden className="absolute -top-24 -right-24 h-72 w-72 rounded-full bg-white/20 blur-3xl" />
          <div aria-hidden className="absolute -bottom-32 -left-20 h-80 w-80 rounded-full bg-white/15 blur-3xl" />
          <div aria-hidden className="absolute inset-0 bg-[radial-gradient(circle_at_1px_1px,rgba(255,255,255,0.15)_1px,transparent_0)] [background-size:24px_24px] opacity-30" />
          ...
          <div className="relative grid md:grid-cols-[1fr_auto] items-center gap-8">
            <div className="text-white">
              ...
              <h2 id="offer-heading" className="mt-4 font-display text-3xl sm:text-5xl lg:text-6xl font-semibold tracking-[-0.02em] leading-[1.05]">
                Ready to order?
              </h2>
              <p className="mt-4 text-white/90 text-lg max-w-lg">
                Everything students need. Delivered in minutes. No minimum order. Only ₹1 delivery fee.
              </p>
            </div>

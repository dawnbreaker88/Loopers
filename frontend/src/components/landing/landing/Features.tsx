...
import bramiDabbulu from "@/assets/brami-dabbulu.png.asset.json";
import shopFreely from "@/assets/shop-freely-v2.png.asset.json";
  ...
  return (
    <section id="features" aria-labelledby="features-heading" className="relative py-16 sm:py-24">
      <div className="mx-auto max-w-7xl px-5 sm:px-8">
        <SectionHeading
          eyebrow="Why Loopers"
          title={<>Fair pricing. <span className="text-muted-foreground">Real convenience.</span></>}
        />
            ...
            <div className="relative w-full max-w-4xl">
              ...
              >
                <div className="flex flex-col items-center justify-center text-center gap-3 sm:gap-4 p-4 sm:p-6 lg:p-8">
                  <p className="text-xs sm:text-sm uppercase tracking-[0.18em] text-shop-freely-text/80 font-bold">
                  </p>

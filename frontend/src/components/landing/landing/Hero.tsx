...
import bagAvif480 from "@/assets/loopers-bag-480.avif.asset.json";
import bagAvif800 from "@/assets/loopers-bag-800.avif.asset.json";
import bagAvif1200 from "@/assets/loopers-bag-1200.avif.asset.json";
import bagAvif1600 from "@/assets/loopers-bag-1600.avif.asset.json";
import bagWebp480 from "@/assets/loopers-bag-480.webp.asset.json";
import bagWebp800 from "@/assets/loopers-bag-800.webp.asset.json";
import bagWebp1200 from "@/assets/loopers-bag-1200.webp.asset.json";
import bagWebp1600 from "@/assets/loopers-bag-1600.webp.asset.json";

const avifSrcSet = `${bagAvif480.url} 480w, ${bagAvif800.url} 800w, ${bagAvif1200.url} 1200w, ${bagAvif1600.url} 1600w`;
const webpSrcSet = `${bagWebp480.url} 480w, ${bagWebp800.url} 800w, ${bagWebp1200.url} 1200w, ${bagWebp1600.url} 1600w`;

...
export default function NotificationPermissionPrompt() {
  ...
  useEffect(() => {
    ...
    if (!('Notification' in window) || !('serviceWorker' in navigator)) {
      console.log('[Notification Prompt] Push notifications not supported in this browser.');
      return;
    }
  ...
  const checkAndSyncSubscription = async () => {
    try {
      ...
      if (subscription) {
        ...
        console.log('[Notification Sync] Push subscription synced with backend successfully.');
      }
    } catch (err) {
